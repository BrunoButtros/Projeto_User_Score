...
public class AuthenticationController {
    ...
    public ResponseEntity register(@RequestBody @Validated RegisterDTO data) {
        ...
        String encrypterdPassword = new BCryptPasswordEncoder().encode(data.password());
        UsuarioEntity novoUsuario = new UsuarioEntity(data.login(), encrypterdPassword, data.role());
